...
**GitHub:** https://github.com/Hosamane/inventoryManagementSystem.git  
**Live demo:** https://inventory-jet-chi.vercel.app/
...
```bash
git clone https://github.com/Hosamane/inventoryManagementSystem.git
cd inventory-system
npm install
```
